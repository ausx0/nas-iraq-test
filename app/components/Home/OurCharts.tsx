...
const OurCharts = () => {
  ...
  return (
    <div className="flex   flex-col items-center px-2 gap-4 md:justify-start md:items-start md:px-10 justify-center mt-8 w-full  container mx-auto">
      <h1 className="text-2xl md:text-4xl font-semibold text-white mb-4">
        {t("OurCharts")}
      </h1>
      <div className="flex flex-col md:flex-row items-center px-2 gap-4 justify-center mt-8 w-full max-w-lg md:max-w-full mx-auto">
        <div className="w-full p-3 bg-[#1E1E1E]   shadow-lg rounded-sm">
          <h2 className="text-xl mx-4 text-white">{t("NetProfit")}</h2>
          <p className="text-sm mx-4 text-gray-400">
